<div x-data="{ open: false }" class="relative">
    <button
        @click="open = !open"
        class="bg-amber-300 text-gray-700 font-bold py-1 px-16 rounded inline-flex items-center hover:bg-amber-400"
    >
    ...
    >
        <li>
            <a
                class="text-black bg-amber-100 hover:bg-amber-300 py-1 px-3 block whitespace-no-wrap font-medium"

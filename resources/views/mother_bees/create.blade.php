<x-layout class="bg-gray-300">
    ...
    >
        ...
        <form method="POST" action="{{ route('motherbees_store', ['apiary' => $apiary, 'beehive' => $beehive]) }}">
            @csrf
            <div class="mb-6">
                <label
                    for="race"
            ...
            <div class="mb-6">
                ...
                <input type="date" name="placement_date" class="border border-gray-600 rounded p-2 w-full bg-gray-300">
            ...
            <div class="mb-6">
                ...
                <input type="date" name="birth_date" class="border border-gray-600 rounded p-2 w-full bg-gray-300">
            ...
            <div class="mb-6">
                ...
                <select name="state" class="border border-gray-600 rounded p-2 w-full bg-gray-300">
                    <option value="unasieniona" {{ old('strength') === 'unasieniona' ? 'selected' : '' }}>Unasieniona</option>
                    <option value="nieunasieniona" {{ old('strength') === 'nieunasieniona' ? 'selected' : '' }}>Nieunasieniona</option>
                    <option value="trutniowa" {{ old('strength') === 'trutniowa"' ? 'selected' : '' }}>Trutniowa</option>
                </select>
